...
export default class Cart extends PageManager {
    ...
    updateRelatedProducts(context){
        ...
        async function getProductsData(productId) {
          ...
          async function getRelatedProducts(context) {
            const getEntityIdQuery = `
              query productById {
                site {
            ...
            try {
              ...
              const promises = relatedProductsIDs.map((productId) => getProductsData(productId));
